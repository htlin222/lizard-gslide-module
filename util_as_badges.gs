...
function convertToBadges() {
  ...
  items.forEach(item => {
    ...
    const badge = slide.insertShape(SlidesApp.ShapeType.TEXT_BOX, x, y, textWidth, height);
    ...
    badgeText.getParagraphStyle().setParagraphAlignment(SlidesApp.ParagraphAlignment.END);
